...
for _ in {1..999}; do
    sleep 0.1 && RUST_BACKTRACE=1 RUST_LOG="aes67_rs_ui=warn,aes67_rs_jack_vsc=warn,aes67_rs::monitoring=warn,statime=warn,info" ./target/debug/aes67-rs-jack-vsc --config ./config.yaml --data-dir ./data
done
