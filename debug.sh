...
# for _ in {1..999}; do
    ...
    RUST_BACKTRACE=1 RUST_LOG="aes67_rs_ui=info,aes67_rs_jack_vsc::session_manager=warn,aes67_rs::monitoring=warn,statime=warn,worterbuch=warn,tosub=warn,sap_rs=warn,aes67_rs_jack_vsc::common=debug,aes67_rs::buffer::sender=debug,info" pw-jack -p 192 ./target/debug/aes67-rs-jack-vsc --config ./config.yaml --data-dir ./data
# done
