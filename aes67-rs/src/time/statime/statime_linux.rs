...
pub async fn statime_linux(
    ...
    let mac = iface.mac.expect("network interface has no mac address");
    ...
    info!("Clock identity: {}", hex::encode(clock_identity.0));
